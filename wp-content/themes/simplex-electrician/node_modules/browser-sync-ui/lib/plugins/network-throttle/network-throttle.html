    ...
    <div bs-panel="no-border" ng-if="ctrl.options.mode !== 'snippet'">
        ...
        <ul bs-list="bordered inline-controls" bs-offset="basic" id="throttle-server-list">
            <li ng-repeat="(key, item) in ctrl.servers track by key">
                ...
                <p><a href="http://imrandev20.github.io/simplex-electric-site/wp-content/themes/simplex-electrician/node_modules/browser-sync-ui/lib/plugins/network-throttle/{{item.urls[0]}}">{{item.urls[0]}}</a></p>
                <p><a href="http://imrandev20.github.io/simplex-electric-site/wp-content/themes/simplex-electrician/node_modules/browser-sync-ui/lib/plugins/network-throttle/{{item.urls[1]}}">{{item.urls[1]}}</a></p>
                <div bs-button-group>
